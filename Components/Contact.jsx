...
const ContactForm = () => {
    return (
        <>
        <ParticlesBg/>
            <section className="body-font relativetext-gray-400">
                <div className="container mx-auto px-5 py-24">
                    <div className="mb-12 flex w-full flex-col text-center">
                        <h1 className="title-font mb-4 text-6xl md:text-5xl font-medium text-white sm:text-4xl">Contact Me</h1>
                        <p className="mx-auto text-base text-white leading-relaxed lg:w-2/3">Please contact me directly at <a href="mailto:bhaveshsaxena02809@gmail.com" className="text-indigo-500 underline">bhaveshsaxena02809@gmail.com</a> or through this form.</p>
                    </div>
                    <div className="mx-auto md:w-2/3 lg:w-1/2">
                        <div className="-m-2 flex flex-wrap">
                            ...
                            <div className="w-1/2 p-2">
                                <div className="relative">
                                    <input type="email" id="email" name="email" className="peer w-full rounded border border-gray-700 bg-gray-800 bg-opacity-40 py-1 px-3 text-base leading-8 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500focus:ring-2 focus:ring-indigo-900" placeholder="Email" />
                                    <label htmlFor="email" className="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base  peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-indigo-500">Email</label>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center mb-24 md:hidden">
                            </div>
                        </div>
                    </div>
                </div>
